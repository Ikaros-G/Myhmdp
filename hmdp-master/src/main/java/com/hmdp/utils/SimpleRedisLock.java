...
public class SimpleRedisLock implements ILock {
    ...
    public SimpleRedisLock(Long userid, StringRedisTemplate stringRedisTemplate) {
    ...
    public boolean tryLock(Long timeoutSec) {
        ...
        Boolean lock = stringRedisTemplate.opsForValue()
                .setIfAbsent(KET_PREFIX + name, ID_PREFIX + currentId, timeoutSec, TimeUnit.SECONDS);
    ...
    public void unLock() {
        ...
        // if (id.equals(stringRedisTemplate.opsForValue().get(KET_PREFIX + name))){
        //     stringRedisTemplate.delete(KET_PREFIX + name);
        // }
